...
txt1 = "Kabir is {} years old. He studies in {} grade in his hometown {}". format(13,"8th", "Calgary.")
txt2 = "One of Kabir's hobbies is {} and he spends {} hours everyday trying to master it.".format("basketball", 4)
txt3 = "He wishes to become {} once he grows up and serve the {}".format("an NBA player", "nobody.")
print(txt1)
print(txt2)
print(txt3)
...
text1= "I don't realy have a {}. I only have one {} which is to be a better {} of my self.". format("role model", "goal","version")
text2= "My soul {} is to improve my self in terms of my {}, {}, {}, {}. In conclusion my {} is a better me.(Version 2.0)". format("goal", "health", "stamina", "Immune system", "and my body in general", "role model")
