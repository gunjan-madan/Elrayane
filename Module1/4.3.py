...
dataType1="book"                  #string
dataType2=24                      #int
dataType3=True                    #bool
dataType4=4.5                     #float

#Let's print them
# the print statement will print any data type value on to the output terminal 
...
print("Do you have a sibling: bool")
print("Color of the leaf: string")
print("Number of books in your shelf: int")
